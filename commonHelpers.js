import{a as d}from"./assets/vendor-bdb8a163.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))c(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&c(r)}).observe(document,{childList:!0,subtree:!0});function s(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function c(i){if(i.ep)return;i.ep=!0;const o=s(i);fetch(i.href,o)}})();function f(t,e){const s=[];return e.forEach(c=>{t.includes(c.difficulty)&&s.push(c)}),s}d.defaults.baseURL="https://dummyjson.com/recipes";async function h(){const{data:t}=await d("");return t}async function y(t){const{data:e}=await d(`/${t}`);return e}async function g(t){const{data:e}=await d("/search",{params:{q:t}});return e}const n={recipesList:document.querySelector(".recipes"),bodyEl:document.querySelector("body"),switchEl:document.querySelector("#switch-theme"),form:document.querySelector(".form"),backdrop:document.querySelector(".backdrop"),modal:document.querySelector(".modal"),parcing:document.querySelector(".parcing"),recipes:"",applyFilter:document.querySelector(".filter"),theme:document.querySelector(".theme"),moonBox:document.querySelector(".moon-container")};function a(t){n.recipesList.innerHTML="";const e=t.map(({id:s,image:c,name:i,difficulty:o,cuisine:r})=>`<li class="recipe-item" data-id='${s}'>
    ...
    </div>`,e==="dark"){const s=document.querySelector(".sun-container");n.bodyEl.classList.add("dark-theme"),n.modal.classList.add("dark-theme"),s.classList.add("visually-hidden")}else document.querySelector(".moon-container").classList.add("visually-hidden")}document.addEventListener("DOMContentLoaded",$);document.addEventListener("DOMContentLoaded",S);document.addEventListener("click",q);n.form.addEventListener("submit",v);n.switchEl.addEventListener("click",k);n.applyFilter.addEventListener("change",E);
